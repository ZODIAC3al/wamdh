    ...
    <div className="relative mx-auto w-[280px] h-[570px] bg-[#0A0D1A] rounded-[36px] p-3 border-4 border-[#1E2538] shadow-2xl flex flex-col overflow-hidden">
      ...
      <div className="w-full h-full bg-[#121628] rounded-[28px] overflow-hidden relative flex flex-col pt-6 text-white select-none">
        ...
        {activeScreen === "chat" && (
          <div className="flex-1 flex flex-col p-4 justify-between">
              ...
              <div className="flex items-center gap-2">
                ...
                <div>
                  ...
                  <p className="text-[8px] text-emerald-400 font-semibold">
                    Active Study Assistant
                  </p>
                </div>
              </div>
              <span className="bg-violet-500/20 text-violet-400 text-[8px] font-bold px-2 py-0.5 rounded-full border border-violet-500/30">
                ELI5
              </span>
            </div>
            ...
            <div className="flex-1 flex flex-col gap-2 overflow-y-auto pt-2 scrollbar-none">
              <div className="bg-white/5 border border-white/5 rounded-2xl p-2.5 max-w-[85%] self-start">
                <p className="text-[10px] text-gray-300">
                  Hi! I parsed your 'Linear Algebra' notes. Ask me anything, or
                  toggle ELI5 to simplify.
                </p>
              </div>
              ...
              <div className="bg-white/5 border border-white/5 rounded-2xl p-2.5 max-w-[85%] self-start">
                <p className="text-[10px] text-gray-300 font-medium">
                  Imagine stretching a grid. Eigenvectors keep their direction;
                  eigenvalues represent how much they stretch! 🚀
                </p>
              </div>
            </div>
            ...
            <div className="mt-2 flex gap-1 bg-white/5 border border-white/5 rounded-xl p-1.5 items-center">
              ...
              <div className="ml-auto bg-violet-600 px-2 py-1 rounded-lg text-[9px] font-bold">
                ELI5: ON
              </div>
            </div>
          </div>
        ...
        {activeScreen === "flashcards" && (
          <div className="flex-1 flex flex-col p-4 justify-between">
            <div>
              <p className="text-[10px] text-violet-400 uppercase tracking-wider font-bold">
                Spaced Repetition
              </p>
              <h4 className="text-sm font-extrabold text-white">
                Deck: Medical Physiology
              </h4>
            </div>
            ...
            <div className="my-auto bg-white/5 border border-white/10 rounded-2xl p-4 min-h-[160px] flex flex-col justify-center items-center text-center shadow-inner relative">
              <div className="absolute top-2 left-3 bg-violet-500/10 text-violet-400 text-[8px] font-extrabold px-2 py-0.5 rounded-full">
                Card 14/40
              </div>
              ...
              <div className="mt-4 border-t border-white/10 pt-2 w-full">
                <p className="text-[10px] text-emerald-400 font-bold">
                  Answer: Powerhouse of the cell, generating ATP.
                </p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-4 gap-1 mt-2">
              {[
                ...
                <button
                  key={i}
                  className={`py-2 rounded-lg border text-[9px] font-bold text-center ${b.style}`}
                >
                  {b.name}
                </button>
              ))}
        ...
        {activeScreen === "planner" && (
          <div className="flex-1 flex flex-col p-4 justify-between">
            ...
            <div className="flex-1 flex flex-col gap-2 my-4 overflow-y-auto max-h-[220px] scrollbar-none">
              {[
                {
                  name: "Biology Chapter 4 Review",
                  time: "9:00 AM",
                  done: true,
                },
                {
                  name: "Quiz on Quantum Physics",
                  time: "2:00 PM",
                  active: true,
                },
                ...
                <div
                  key={idx}
                  className="bg-white/5 border border-white/5 rounded-xl p-2.5 flex justify-between items-center"
                >
                  <div className="flex items-center gap-2">
                    ...
                    <div>
                      <p
                        className={`text-[10px] font-bold text-white leading-tight ${task.done ? "line-through text-gray-500" : ""}`}
                      >
                        {task.name}
                      </p>
                  ...
                  <span
                    className={`text-[8px] px-1.5 py-0.5 rounded font-bold ${task.done ? "bg-emerald-500/10 text-emerald-400" : task.active ? "bg-amber-500/10 text-amber-400" : "bg-white/5 text-gray-400"}`}
                  >
            ...
            <div className="bg-white/5 rounded-2xl p-2.5 flex flex-col gap-1.5 border border-white/5">
              <div className="flex justify-between items-center">
                ...
                <span className="text-[8px] text-yellow-400 font-extrabold">
                  +150 XP Today 🔥
                </span>
              </div>
    ...
    <div className="w-full min-h-screen bg-[#F7F8FB] overflow-x-hidden font-sans">
        ...
        <div className="max-w-[1280px] mx-auto w-full grid grid-cols-1 lg:grid-cols-12 gap-12 items-center relative z-10">
          ...
          <div className="lg:col-span-6 text-left flex flex-col items-start">
            ...
            <p className="text-[#E4E9FF] text-base md:text-lg max-w-xl leading-relaxed mb-8 animate-fade-in-up delay-100">
              Master your classes with a unified AI study platform. Scan notes
              with OCR, converse with a context-grounded AI tutor, review spaced
              cards, and stay on track with smart schedules.
            </p>
            ...
            <div className="flex flex-wrap items-center gap-4 mb-8 w-full animate-fade-in-up delay-200">
              ...
              <button
                onClick={handleDownload}
                className="flex items-center gap-2 text-white font-bold hover:text-[#E4E9FF] transition-all group"
              >
            ...
            <div className="flex flex-wrap gap-3 animate-fade-in-up delay-300">
              <button onClick={handleDownload} className="store-btn">
                ...
                <div className="text-left">
                  <span className="block text-[9px] text-white/50 uppercase leading-none">
                    Download on the
                  </span>
      ...
      <section id="features" className="py-24 px-6 md:px-12 bg-[#F7F8FB]">
        <div className="max-w-[1280px] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="reveal flex flex-col items-start">
            <span className="text-[#2547F4] text-[14px] font-bold uppercase tracking-widest mb-4">
              About Wamdh
            </span>
            ...
            <p className="text-[#6B7280] text-base leading-relaxed mb-8 max-w-xl">
              Experience a unified study workspace. Snap images of your lecture
              notes or upload PDFs to trigger high-quality OCR text extraction.
              Our RAG-based search grounds Mona, your study companion, to answer
              questions with full accuracy from your materials.
            </p>
            <button
              onClick={handleDownload}
      ...
      <section className="py-24 px-6 md:px-12 bg-white overflow-hidden">
        <div className="max-w-[1280px] mx-auto grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
          ...
          <div className="lg:col-span-5 reveal flex flex-col items-start text-left">
            <h2 className="text-[#12131A] font-extrabold text-4xl mb-4 leading-tight">
              Campus Reach
            </h2>
            <p className="text-[#6B7280] text-base leading-relaxed mb-6 max-w-md">
              Wamdh is used by university students and educators globally to
              streamline studying, review spacing, and track academic metrics.
            </p>
          </div>
      ...
      <section className="py-24 px-6 md:px-12 bg-[#F7F8FB] overflow-hidden relative">
        ...
        <div
          ...
          style={{
            backgroundImage:
              "linear-gradient(to right, #12131A 1px, transparent 1px), linear-gradient(to bottom, #12131A 1px, transparent 1px)",
            backgroundSize: "100px 100px",
          }}
        />

        <div className="max-w-[1280px] mx-auto text-center relative z-10">
          <h2 className="text-[#12131A] font-extrabold text-4xl mb-4 reveal">
            Testimonials
          </h2>
          <p className="text-[#6B7280] text-base max-w-lg mx-auto mb-16 reveal delay-100">
            Hear how students are accelerating their learning schedules and
            grades with Wamdh.
          </p>
          ...
          <div className="relative min-h-[460px] flex items-center justify-center">
            ...
            <div className="bg-white rounded-3xl p-8 md:p-10 border border-[#E7E9F0] shadow-card max-w-[580px] w-full mx-auto relative z-10 transition-all duration-500 hover:shadow-xl">
              ...
              <div className="flex flex-col items-center mb-6">
                ...
                <h5 className="text-[#12131A] font-extrabold text-base leading-tight">
                  {testimonials[testimonialIdx].name}
                </h5>
                <p className="text-[#6B7280] text-xs font-semibold uppercase tracking-wider mt-0.5">
            ...
            {[
              {
                name: "Standard Plan",
                price: "$0",
                desc: "Complete access to the platform utilities.",
                features: [
                  "Unlimited OCR note processing",
                  "AI summaries & chat conversations",
                  "Unlimited quizzes & cards",
                  "Full planner & calendars",
                ],
                highlight: true,
              },
            ].map((p, idx) => (
              ...
              >
                ...
                <div>
                  <h4 className="text-[#12131A] font-extrabold text-lg mb-2">
                    {p.name}
                  </h4>
                  <div className="flex items-baseline justify-center gap-1 my-4">
                    <span className="text-[#12131A] font-black text-4xl">
                      {p.price}
                    </span>
      ...
      <section className="py-24 px-6 md:px-12 bg-[#F7F8FB]">
        <div className="max-w-[720px] mx-auto text-center">
          <h2 className="text-[#12131A] font-extrabold text-4xl mb-12 reveal">
            FAQ's
          </h2>
          ...
          <div className="space-y-4 text-left reveal delay-100">
            {[
              {
                q: "What is Wamdh?",
                a: "Wamdh is a unified AI study platform combining OCR note ingestion, context-grounded AI chat tutoring, spaced repetition flashcards, quizzes, and automated planner scheduling.",
              },
              {
                q: "How does the AI Chat Tutor work?",
                a: "The AI Chat Tutor ('Mona') uses retrieval-augmented generation (RAG) to scan and reference your notes locally, ensuring responses are completely grounded in your syllabus.",
              },
              {
                q: "Is the app completely free?",
                a: "Yes, our Standard Plan is free forever and unlocks all primary features including unlimited OCR note scanning, summaries, study planners, and flashcards.",
              },
              {
                q: "Is it available on Android and iOS?",
                a: "Yes! A standalone APK is available for direct installation on Android, and iOS beta previews are available through Apple TestFlight.",
              },
            ].map((faq, idx) => (
              <div
                key={idx}
              ...
              >
                <div className="flex justify-between items-center gap-4">
                  <span className="text-[#12131A] font-extrabold text-[15px]">
                    {faq.q}
                  </span>
                  <span
                    className={`text-xl font-bold transition-all ${openFaq === idx ? "rotate-45 text-[#2547F4]" : "text-gray-400"}`}
                  >
                    +
                  </span>
                </div>
                <div
                  className={`overflow-hidden transition-all duration-300 ${openFaq === idx ? "max-h-40 mt-3 pt-3 border-t border-gray-100" : "max-h-0"}`}
                >
        ...
        <div className="max-w-[1280px] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="reveal flex flex-col items-start">
            ...
            <p className="text-[#6B7280] text-base leading-relaxed mb-8 max-w-md">
              Take your study environment with you. Scan notes, practice
              flashcards, and coordinate schedules on your mobile device.
            </p>
            ...
            <div className="flex flex-wrap gap-3 mb-8 w-full">
              <button
                onClick={handleDownload}
                className="store-btn dark bg-black border-transparent text-white"
              >
                <svg
          ...
          <div className="reveal relative flex justify-center items-center delay-200">
            ...
            <div className="absolute left-[10%] top-[10%] opacity-15 pointer-events-none w-48 h-48 grid grid-cols-6 gap-2">
              {[...Array(36)].map((_, i) => (
                <div
                  key={i}
                  className="w-1.5 h-1.5 rounded-full bg-[#12131A]"
                />
              ))}
            </div>
            <PhoneMockup activeScreen="flashcards" />
        ...
        <div className="max-w-[1280px] mx-auto relative z-10">
          ...
          <div className="text-center pb-20 border-b border-white/10 flex flex-col items-center">
            ...
            <div className="relative group">
              ...
              <div className="absolute -left-6 top-1/2 transform -translate-y-1/2 text-[#FF6B57] font-black text-xl select-none animate-pulse">
                彡
              </div>
              <button
                onClick={handleDownload}
              ...
              <div className="absolute -right-6 top-1/2 transform -translate-y-1/2 text-[#FF6B57] font-black text-xl select-none animate-pulse">
                ミ
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-12 py-16">
            ...
            <div className="md:col-span-4 flex flex-col items-start text-left">
              ...
              <p className="text-gray-400 text-sm leading-relaxed mb-6 max-w-sm">
                ❤️ Empowering students to build their dream future with
                next-generation AI revision tools.
              </p>
            ...
            <div className="md:col-span-2 text-left">
              <h4 className="font-bold text-xs uppercase tracking-widest text-[#2547F4] mb-5">
                General
              </h4>
            ...
            <div className="md:col-span-2 text-left">
              ...
              <a
                href="#"
                className="text-[#FF6B57] hover:text-[#FF8E9C] text-xs font-bold flex items-center gap-1.5 transition-colors"
              >
